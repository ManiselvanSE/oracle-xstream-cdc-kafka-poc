...
- [docs/CUSTOMER_DEMO_RUNBOOK.md](docs/CUSTOMER_DEMO_RUNBOOK.md) – **Simple customer/demo runbook (system flow, start/stop, HammerDB, CDC, Kafka, validation, troubleshooting)**
