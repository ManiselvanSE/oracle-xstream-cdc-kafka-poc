...
#   HDB_MTX_NO_TC     — true (default here) skips tcstart/tcstop to avoid TC ORA-28000; full load: false
...
# Avoid HammerDB transaction-counter noise (ORA-28000) — workload uses ORDERMGMT only.
